...
<?php 
    ...
    if ($_GET["err"] == "3") { 
?>
        <div style="color:red;"> ERR 3 </div>
<?php 
    }
    if ($_GET["err"] == "4") { 
?>
        <div style="color:red;"> ERR 4 </div>
<?php 
    }
    if ($_GET["err"] == "5") { 
?>
        <div style="color:red;"> ERR 5 </div>
<?php 
    } 
    if ($_GET["err"] == "13") { 
?>
        <div style="color:red;"> ERROR 13 SESSION </div>
<?php 
    }
    if ($_GET["err"] == "25") { 
?>
...
<?php 
    ...
    if ($_GET["err"] == "emptylog") {
?>
        <div style="color:red;">  Логин не введен  </div>
<?php 
    }
    if ($_GET["err"] == "emptypass") { 
?>
        <div style="color:red;"> Пароль не введен  </div>
<?php 
    }
    if ($_GET["err"] == "emptyemail") { 
?>
        <div style="color:red;">  E-mail не введен  </div>
<?php
    }
    if ($_GET["err"] == "wrongpass") { 
?> 
...
<?php
    ...
    if ($_GET["err"] == "313") { 
?> 
        <div style="color:red;">  Логин занят  </div>
